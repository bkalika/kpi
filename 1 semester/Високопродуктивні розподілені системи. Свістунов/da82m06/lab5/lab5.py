...
def plot_results(vt, vq1, vq2, vi1, vi2, vur2):
    ...
    f1 = plt.figure(1)
    f1.suptitle('Q1 result:')
    plt.xlabel('t')
    plt.ylabel('Q')
    plt.plot(vt, vq1, color='pink')

    f2 = plt.figure(2)
    f2.suptitle('Q2 result:')
    plt.xlabel('t')
    plt.ylabel('Q')
    plt.plot(vt, vq2, color='green')

    f3 = plt.figure(3)
    f3.suptitle('I1')
    plt.xlabel('t')
    plt.ylabel('I')
    plt.plot(vt, vi1, color='cyan')

    f4 = plt.figure(4)
    f4.suptitle('I2 result:')
    plt.xlabel('t')
    plt.ylabel('I')
    plt.plot(vt, vi2, color='red')

    f5 = plt.figure(5)
    f5.suptitle('Ur2 result:')
    plt.xlabel('t')
    plt.ylabel('U')
    plt.plot(vt, vur2, color='orange')
    ...
    if '--plot' in sys.argv:
        ...
        with open(FILE_NAME, 'w') as f:
            for t, q1, q2, i1, i2, ur2 in list(zip(vt, vq1, vq2, vi1, vi2, vur2))[::100]:
                ...
                print("%0.10f %0.20f %0.20f %0.20f %0.20f %0.20f\n" % (t, q1, q2, i1, i2, ur2))
